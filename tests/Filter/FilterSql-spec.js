...
function testFilter(assert, fromFilter, sql, model) {
    ...
    if ( !isEqual ) {
        let a = normolizeSyntaxBeforePrint(parsedSql);
        let b = normolizeSyntaxBeforePrint(parsedFilterSql);
        console.log("break here", a, b);
    }
...
QUnit.module("Filter building sql", {}, function() {
